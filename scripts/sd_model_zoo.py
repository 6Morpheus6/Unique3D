...
DEFAULT_BASE_MODEL = "cocktailpeanut/stable-diffusion-v1-5"
...
def load_common_sd15_pipe(base_model=DEFAULT_BASE_MODEL, device=None, controlnet=None, ip_adapter=False, plus_model=True, torch_dtype=torch.float16, model_cpu_offload_seq=None, enable_sequential_cpu_offload=False, vae_slicing=False, pipeline_class=None, **kwargs):
    model_kwargs = dict(
        torch_dtype=torch_dtype,
        requires_safety_checker=False, 
        safety_checker=None,
